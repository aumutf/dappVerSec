...
const mainTasks = gulp.series(fonts, gulp.parallel(copy, html, scss, scssPosts, scssSearch, scssGallery, scssProfile, scssTags, scssBlockchain, scssBlockchainCat, js, images, svgSpriteTask, assets));
